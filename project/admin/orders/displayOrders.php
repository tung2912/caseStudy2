            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a href="displayOrders.php">Orders</a></li>
                    </ol>
                    <a href="#" style="font-size: larger;">Add a new product</a>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php foreach ($displayOrders as $row): ?>
                                            <tr>
